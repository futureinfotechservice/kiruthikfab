...
class ProductApiService {
  Future<String> insertProduct({
    ...
    var url = Uri.parse('$baseUrl/product_insert.php');
  ...
  Future<String> updateProduct({
    ...
    var url = Uri.parse('$baseUrl/product_update.php');
  ...
  Future<List<ProductMasterModel>> fetchProducts(BuildContext context) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    final companyid = prefs.getString('companyid') ?? '';
    ...
    var url = Uri.parse('$baseUrl/product_fetch.php');
    print("Fetching products for companyid: $companyid");
    ...
    try {
      ...
      print("Fetch Error: $e");
      _showError(context, "Error fetching products: $e");
      return [];
    }
  }

  Future<String> deleteProduct(BuildContext context, String productId) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    final companyid = prefs.getString('companyid') ?? '';
    ...
    var url = Uri.parse('$baseUrl/product_delete.php');
    try {
      var response = await http.post(
        url,
        headers: {'Content-Type': 'application/x-www-form-urlencoded'},
