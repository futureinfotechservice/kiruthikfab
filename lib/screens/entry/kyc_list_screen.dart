...
class _KYCListScreenState extends State<KYCListScreen> {
  ...
  Future<void> _deleteKYC(String kycId, int index) async {
    ...
    if (confirmed == true) {
      try {
        String result = '';
        if (mounted) result = await _kycService.deleteKYC(context, kycId);
  ...
  void _navigateToKYCEntry({Map<String, dynamic>? kycData}) async {
    final result = await Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => KYCEntryScreen(kycData: kycData)),
    );
  ...
  List<KYCMasterModel> get _filteredKYC {
    ...
    return _kycList.where((kyc) {
      return kyc.customerName.toLowerCase().contains(
          ...
          Row(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(product.size, style: const TextStyle(fontSize: 11)),
              ),
            ],
          ),
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  Text(
                    '₹ ${double.tryParse(product.totalAmount)?.toStringAsFixed(2) ?? '0.00'}',
                    style: const TextStyle(
                      fontSize: 12,
      ...
      child: Theme(
        ...
        child: ExpansionTile(
          ...
          leading: CircleAvatar(
            ...
            radius: 25,
            child: Text(
              kyc.customerName.isNotEmpty
                  ? kyc.customerName[0].toUpperCase()
                  : 'K',
              style: const TextStyle(
                color: Colors.white,
                fontSize: 18,
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        tooltip: "Add kyc list",
        heroTag: "Add kyc list",
        onPressed: () => _navigateToKYCEntry(),
        backgroundColor: const Color(0xFF1E293B),
