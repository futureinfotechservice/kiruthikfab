...
// Check if agent already exists for this company
$check_query = "SELECT id FROM agentmaster WHERE companyid = '$companyid' AND agentname = '$agentname' AND activestatus = '1'";
...
// Insert query
$sql = "INSERT INTO agentmaster (companyid, agentname, addedby, activestatus) 
        VALUES ('$companyid', '$agentname', '$addedby', '$activestatus')";
