...
$check_query = "SELECT id FROM customermaster WHERE mobile1 = '$mobile1' AND companyid = '$companyid' AND id != '$customerid'";
$result = mysqli_query($conn, $check_query);
if (mysqli_num_rows($result) > 0) {
    echo json_encode(["status" => "error", "message" => "Mobile number already exists for another customer"]);
    mysqli_close($conn);
    exit();
}
