...
// Insert query
$sql = "INSERT INTO salespersonmaster (companyid, salespersonname, addedby, activestatus,password,type) 
        VALUES ('$companyid', '$salespersonname', '$addedby', '$activestatus','$password','$user_type')";
